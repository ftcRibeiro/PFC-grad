\chapter{Resultados}
No início do projeto, ainda na etapa de levantamento de requisitos e análise da estrutura existente (\ref{sec:levantRequisitos} e \ref{sec:estruturaExistente}) foram 
...
\todo[inline]{Apresentar aqui como as etapas do processo de desenvolvimento possibilitaram a geração de uma documentação de qualidade das regras de negócio do fluxo de cálculos dos índices de performance}
