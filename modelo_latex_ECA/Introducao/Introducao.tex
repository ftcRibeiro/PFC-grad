...
\begin{itemize}
	...
	\item \textbf{Registro de falhas:} É necessário que o módulo apresente registros de falhas de cada uma das execuções, não somente listando, mas também identificando quais tipos;
\end{itemize}
