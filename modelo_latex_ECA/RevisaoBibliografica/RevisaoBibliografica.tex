...
Existem diversos modelos de processo de software \cite{engSw} , dentre eles o modelo cascata, também conhecido como ciclo de vida de software. Este modelo consiste no encadeamento de suas etapas, tendo o início de uma associado necessariamente ao final de outra. São elas:
\begin{itemize}
...
\begin{figure}[!htbp]
	...
	\caption{Modelo de sequência (Fonte: Autor)}
	\label{fig:seqModel}
\end{figure}
...
\begin{figure}[!htbp]
	...
	\caption{Arquitetura genérica em camadas (Fonte: Autor)}
